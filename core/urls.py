...
from core.views import home, patrimony, profile, patrimony_create, patrimony_edit, inventory_form, patrimony_detail, record_form, records, records_scan, inventory, inventory_detail
